...
from tkinter import Tk, Canvas, Entry, Text, Button, PhotoImage, CENTER, font
...
class LandingScreen(BaseWin):
    ...
    def make_widgets(self):
        ...
        self.canvas.create_text(
            ...
            fill="#A44CD3",
            font=tkinter.font.Font(family='Helvetica',
        size=36*-1, weight='bold')
        )
